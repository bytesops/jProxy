...
import com.github.bytesops.jproxy.crt.CertUtil;
...
import com.github.bytesops.jproxy.server.HttpProxyCACertFactory;
import com.github.bytesops.jproxy.util.ProtoUtil.RequestProto;
...
public class CertDownIntercept extends HttpProxyIntercept {
    ...
    /**
     * Using jproxy's own CA certificate to construct CertDownIntercept
     */
     ...
     * <p> Visitors will receive a CA certificate from CaCertFactory instead of jproxy's built-in certificate.
     *
    ...
    public void beforeRequest(Channel clientChannel, HttpRequest httpRequest,
        ...
        if (!requestProto.getProxy()) {
            ...
            if (httpRequest.uri().matches("^.*/ca.crt.*$")) {  //下载证书
                ...
                HttpResponse httpResponse = new DefaultHttpResponse(HttpVersion.HTTP_1_1,
                        HttpResponseStatus.OK);
                String html = "<html><body><div style=\"margin-top:100px;text-align:center;\"><a href=\"ca.crt\">jProxyRoot ca.crt</a></div></body></html>";
