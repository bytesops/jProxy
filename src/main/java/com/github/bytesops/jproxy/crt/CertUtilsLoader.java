...
import com.github.bytesops.jproxy.crt.service.bc.BouncyCastleCertGenerator;
import com.github.bytesops.jproxy.crt.spi.CertGenerator;
import com.github.bytesops.jproxy.crt.spi.CertGeneratorInfo;
...
/**
 * CertUtil 的内部类.
 * <p>通过 {@link CertGenerator} 让 jProxy 不再固定依赖 BC 加密套件, 可根据需要自行指定套件的相关操作提供给 jProxy.
 */
